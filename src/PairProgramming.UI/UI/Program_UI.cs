...
using System.Threading.Tasks;
    ...
    {
        System.Console.WriteLine("You Find yourself in a barren kitchen. It has a old table with an empty coffee cup in the center with a note next to it.\n" +
        "You approach the table and read the note. It says 'Sweet then Cream, then fill to the top'\n "+
        "As you look around you see 3 things:\n" +
            "1.)	A cup of sugar\n" +
            "2.)	A container of cream\n" +
            "3.)	A pot of hot coffee\n");
    }
